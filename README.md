...
> Minify JavaScript (simple tokenizer)

[![PyPI version](https://badge.fury.io/py/minify-js.svg)](https://pypi.org/project/minify-js/)
...
```bash
pip install minify-js
```

## Quick Start

```python
from minify_js import js

# Basic usage
result = js("your input here")
print(result)
```
